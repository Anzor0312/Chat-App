...
import 'package:telegram/provider/home/home_provider.dart';
...
class MainScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:const Text("Mahsulot Page"),
        leading:const Icon(Icons.menu),
      ),
      body: _streanBuilder(context),
    );
  }

  StreamBuilder<QuerySnapshot<Object?>> _streanBuilder(BuildContext context) {
